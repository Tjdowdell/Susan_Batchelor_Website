jQuery(function($) {
    ...
    $progress_tracker_option.change(function(){
        $(this).is(':checked') ? $('.ab-progress-tracker').show() : $('.ab-progress-tracker').hide();
    }).trigger('change');

    var showTabTime = function() {
        $('li[data-target="#ab-step-3"]').tab('show');
    };
    ...
    multiple.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
        tpl: '<div class="editable-multiple"><label><input type="text" name="label" class="form-control input-sm"></label></div>'+
        '<div style="margin-top:5px;" class="editable-multiple"><label><input type="text" name="option" class="form-control input-sm"><input type="hidden" name="id_option"></label></div><div class="ad--extend" style="display:none">'+
        '<div style="margin-top:5px;" class="editable-multiple"><label><input type="text" name="option2" class="form-control input-sm"><input type="hidden" name="id_option2"></label></div></div></div>',
