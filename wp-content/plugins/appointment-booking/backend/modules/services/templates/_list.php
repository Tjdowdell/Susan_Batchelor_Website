                    ...
                    <div class="row">
                        <div class="col-sm-8 col-xs-10">
                            <div class="bookly-flexbox">
                                ...
                                <div class="bookly-flex-cell bookly-vertical-middle" style="width: 1%">
                                    <span class="bookly-color-picker bookly-margin-right-sm bookly-js-service-color"
                    ...
                    <div class="panel-body">
                        <form method="post">
                                        ...
                                        <div class="btn-group">
                                            <button class="btn btn-default btn-block dropdown-toggle bookly-flexbox" data-toggle="dropdown">
                                                ...
                                                <div class="bookly-flex-cell text-left" style="width: 100%">
                                                    <span class=staff-count><?php echo $service['total_staff'] ?></span>
                                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <p class="help-block">
                                    <?php _e( 'This text can be inserted into notifications with [[SERVICE_INFO]] code.', 'bookly' ) ?>
                                </p>
