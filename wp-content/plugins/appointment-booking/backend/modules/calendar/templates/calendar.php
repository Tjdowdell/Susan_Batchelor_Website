                ...
                <ul class="bookly-nav bookly-nav-tabs">
                    ...
                    <?php if ( \Bookly\Lib\Utils\Common::isCurrentUserAdmin() ) : ?>
                        <div class="btn-group pull-right" style="margin-top: 5px;">
                            ...
                            <ul class="dropdown-menu bookly-staff-selector">
                                <li>
                                    <a class="checkbox" href="javascript:void(0)">
                                        <label><input type="checkbox" id="ab-filter-all-staff"><?php _e( 'All staff', 'bookly' ) ?></label>
                                    </a>
                                </li>
                                <?php foreach ( $staff_members as $i => $staff ) : ?>
                                    <li>
                                        <a class="checkbox" href="javascript:void(0)">
                                            <label>
                                                <input type="checkbox" id="ab-filter-staff-<?php echo $staff->id ?>" value="<?php echo $staff->id ?>" data-staff_name="<?php echo esc_attr( $staff->full_name ) ?>" class="ab-staff-filter">
                                                <?php echo $staff->full_name ?>
                                            </label>
                                        </a>
                                    </li>
