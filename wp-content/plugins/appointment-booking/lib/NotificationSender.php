...
abstract class NotificationSender
{
    ...
    private static function _prepareData( Entities\CustomerAppointment $ca )
    {
        ...
        $codes = new NotificationCodes();
        $codes->set( 'amount_due',        $price - $deposit_price );
     ...
     * @param $content_type
     */
    public static function sendTestEmailNotifications( $toEmail, $sender, $reply_to_customers, $notificationTypes, $content_type )
    {
