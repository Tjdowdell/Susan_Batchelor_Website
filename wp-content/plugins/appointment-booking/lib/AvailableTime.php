...
class AvailableTime
{
    ...
    private function _prepareStaffData()
    {
        ...
        $holidays = Entities\Holiday::query( 'h' )
            ...
            ->whereIn( 'h.staff_id', array_keys( $this->staff_data ) )
        ...
        $working_schedule = Entities\StaffScheduleItem::query( 'ssi' )
            ...
            ->whereIn( 'ssi.staff_id', array_keys( $this->staff_data ) )
        ...
        $bookings = Entities\CustomerAppointment::query( 'ca' )
            ...
            ->whereIn( 'a.staff_id', array_keys( $this->staff_data ) )
        ...
        foreach ( $bookings as $booking ) {
            $this->staff_data[ $booking['staff_id'] ]['bookings'][] = array(
                ...
                'padding_left'       => $booking['padding_left'],
                'padding_right'      => $booking['padding_right'],
