    ...
    <div class="ab-mobile-step_1">
        <div class="bookly-js-chain-item bookly-js-draft bookly-table ab-row" style="display: none;">
            ...
            <div class="ab-formGroup">
                <label><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'ab_appearance_text_label_category' ) ?></label>
                <div>
            ...
            <div class="ab-formGroup">
                <label><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'ab_appearance_text_label_service' ) ?></label>
                <div>
                ...
                <div class="ab-select-service-error ab-label-error" style="display: none">
                    <?php echo esc_html( \Bookly\Lib\Utils\Common::getTranslatedOption( 'ab_appearance_text_required_service' ) ) ?>
                </div>
            </div>
            <div class="ab-formGroup">
                <label><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'ab_appearance_text_label_employee' ) ?></label>
                <div>
                ...
                <div class="ab-select-employee-error ab-label-error" style="display: none">
                    <?php echo esc_html( \Bookly\Lib\Utils\Common::getTranslatedOption( 'ab_appearance_text_required_employee' ) ) ?>
                </div>
            </div>
            <div class="ab-formGroup">
                <label><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'ab_appearance_text_label_number_of_persons' ) ?></label>
                <div>
        ...
        <div class="ab-row">
            <div class="ab-left ab-mob-float-none">
                <div class="ab-available-date ab-left ab-mob-float-none">
                    <div class="ab-formGroup">
                        <span class="ab-label"><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'ab_appearance_text_label_select_date' ) ?></span>
                        <div>
                ...
                <?php if ( ! empty ( $days ) ) : ?>
                    <div class="ab-available-days ab-left ab-mob-float-none">
            ...
            <?php if ( ! empty ( $times ) ) : ?>
                <div class="ab-time-range ab-left ab-mob-float-none">
                    <div class="ab-formGroup ab-time-from ab-left">
                        <span class="ab-label"><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'ab_appearance_text_label_start_from' ) ?></span>
                        <div>
                    ...
                    <div class="ab-formGroup ab-time-to ab-left">
                        <span class="ab-label"><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'ab_appearance_text_label_finish_by' ) ?></span>
                        <div>
